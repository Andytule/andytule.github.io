    ...
    <section id="hero" className="hero">
      <div className="hero__bento">
        ...
        <div className="hero__card hero__card--main">
          ...
          {/* Avatar as full background of the bottom portion */}
        ...
        <div className="hero__card hero__card--resume">
          {/* Resume icon */}
          <svg className="hero__resume-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="hero__resume-actions">
            <button onClick={handleViewPdf} className="hero__resume-btn hero__resume-btn--view">
            ...
            <a href="/andy_le_resume.pdf" download="Andy_Le_Resume.pdf" className="hero__resume-btn hero__resume-btn--download">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="hero__resume-watermark" aria-hidden="true">CV</div>
        </div>

        {/* ── 4. Featured Project ── */}
        <div className="hero__card hero__card--project">
          <div className="hero__project-img">
            <img src="/chord-shift-preview.png" alt="Chord-Shift app" className="hero__project-screenshot" />
          ...
          <div className="hero__project-meta">
            ...
            <div className="hero__project-links">
              <a href="https://github.com/Andytule/chord-shift" target="_blank" rel="noopener noreferrer" className="hero__project-link">
              ...
              <a href="https://chord-shift.vercel.app" target="_blank" rel="noopener noreferrer" className="hero__project-link hero__project-link--live">
                Live ↗
              </a>
            </div>
          </div>
        ...
        {/* ── 5–8. Social tiles ── */}
        <a href="https://calendly.com/andytule321" target="_blank" rel="noopener noreferrer"
           className="hero__card hero__card--social hero__card--calendly">
          <svg className="hero__social-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <a href="mailto:Andytule321@gmail.com"
        ...
        <a href="https://github.com/Andytule" target="_blank" rel="noopener noreferrer"
        ...
        <a href="https://linkedin.com/in/andy-tu-le" target="_blank" rel="noopener noreferrer"
